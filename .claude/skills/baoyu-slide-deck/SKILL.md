...
description: Use when generating professional slide deck images from content. Creates comprehensive outlines with style instructions, then generates individual slide images. Use when user asks to "create slides", "make a presentation", "generate deck", or "slide deck".
---
...
| `--narrative <mode>` | Content narrative mode (see Narrative Modes) |
...
| `neo-brutalism` | Bold black outlines, vibrant colors | Hip, edgy, startup |
| `clean-minimal` | Apple-style, vast whitespace | Premium, executive |
| `glassmorphism` | Frosted glass, blur effects | Futuristic UI, software |
| `bento-grid` | Japanese lunch box, modular cells | Feature showcases, dashboards |
| `claymorphism` | Soft 3D clay, playful pastels | Educational, friendly |
| `dark-tech` | Neon glows, HUD elements | AI/ML, cybersecurity, gaming |
| `gradient-mesh` | Flowing organic colors | Creative, artistic, music |
| `hand-drawn` | Pen sketches, paper texture | Brainstorming, workshops |
| `node-link` | Knowledge graph, connections | Data science, architecture |
| `retro-modern` | 80s tech meets modern AI | Unique branding, indie |
| `toss` | Korean fintech, Toss Blue | Fintech, mobile apps, Korean |
...
| startup, disruptive, hip, edgy, bold graphics | `neo-brutalism` |
| premium, apple, luxury, refined, sophisticated | `clean-minimal` |
| ios, macos, software ui, ux, modern app | `glassmorphism` |
| feature, comparison, grid, modular, overview | `bento-grid` |
| friendly, playful, 3d cute, approachable | `claymorphism` |
| ai, ml, neural, cyber, hacker, futuristic | `dark-tech` |
| artistic, abstract, dreamy, creative agency | `gradient-mesh` |
| brainstorm, workshop, ideation, sketch, doodle | `hand-drawn` |
| knowledge graph, network, connections, data science | `node-link` |
| indie, unique, 80s, synthwave, vaporwave | `retro-modern` |
| fintech, korean, toss, payment, banking, mobile | `toss` |
| Default | `blueprint` |

## Narrative Modes

Content structure modes that work independently with visual styles. Use `--narrative` to set.

| Mode | Description | Best For |
|------|-------------|----------|
| `one-more-thing` | Steve Jobs style - one message per slide, extreme simplicity | Product launches, keynotes |
| `toss-direct` | Toss style - 3 bullets max, instant actionability | Tutorials, onboarding |
| `kinfolk-serif` | Kinfolk style - contemplative storytelling, emotional depth | Lifestyle, brand stories |
| `bento-structure` | 4-compartment modular (concept/data/ideas/next) | Research, analysis |
| `brutalist-edge` | Provocative directness, Bullshit-free summaries | Startup pitches, disruption |
| `magazine-cover` | Vogue cover story style, glamorous headlines | Luxury brands, premium |
| `logic-tree` | McKinsey MECE structure, evidence-based | B2B proposals, investor decks |

### Combining Styles

Visual style and narrative mode work independently:

```bash
/baoyu-slide-deck content.md --style toss --narrative one-more-thing
/baoyu-slide-deck content.md --style corporate --narrative logic-tree
/baoyu-slide-deck content.md --style glassmorphism --narrative toss-direct
```
...
| Narrative mode | Always (recommend based on content, or "none") |
...
| `references/styles/<style>.md` | Full style specifications (27 styles) |
| `references/narrative-modes/<mode>.md` | Narrative mode specifications (7 modes) |
