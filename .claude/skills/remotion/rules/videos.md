---
name: videos
description: Use when embedding videos in Remotion - trimming, volume, speed, looping, pitch
metadata:
...
더 많은 영상 효과를 찾으려면: [effects-catalog.md](effects-catalog.md) | [effects-transitions-scenes.md](effects-transitions-scenes.md)
