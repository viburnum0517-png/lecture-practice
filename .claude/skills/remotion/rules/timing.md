---
name: timing
description: Use when needing interpolation curves in Remotion - linear, easing, spring animations
metadata:
...
더 많은 모션/타이밍 효과를 찾으려면: [effects-catalog.md](effects-catalog.md) | [effects-motion-particles.md](effects-motion-particles.md)
