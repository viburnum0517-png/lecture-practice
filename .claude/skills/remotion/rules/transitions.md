---
name: transitions
description: Use when needing fullscreen scene transitions for Remotion.
metadata:
...
더 많은 전환 효과를 찾으려면: [effects-catalog.md](effects-catalog.md) | [effects-transitions-scenes.md](effects-transitions-scenes.md)
