---
name: images
description: Use when embedding images in Remotion using the <Img> component
metadata:
...
더 많은 이미지/비주얼 효과를 찾으려면: [effects-catalog.md](effects-catalog.md) | [effects-visual-layout.md](effects-visual-layout.md)
